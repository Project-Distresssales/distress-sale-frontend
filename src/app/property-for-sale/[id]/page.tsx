      ...
      <div>
        <div className="w-full h-auto pb-32">
            ...
            <div className="flex items-center space-x-3 w-full">
              <div className="relative inline-block text-left w-full">
                <div>
                  <button
                    type="button"
                    className="flex border border-[#EAECF0] items-center w-full justify-between gap-x-2 rounded-md bg-white px-[16px] py-[12px] text-[1vw] font-[500]"
                    id="menu-button"
                    aria-expanded="true"
                    aria-haspopup="true"
                  >
          ...
          <div className="bg-[fff] w-full h-auto px-[80px] pt-10 pb-20">
            ...
            <div className="flex justify-between items-end">
              ...
              <div className="relative inline-block">
                <div>
                  <button
                    type="button"
                    className="flex border border-[#EAECF0] items-center w-full justify-between gap-x-10 rounded-md bg-white px-[16px] py-[12px] text-[1vw] font-[500]"
                    id="menu-button"
                    aria-expanded="true"
                    aria-haspopup="true"
                  >
            ...
            <div
              className="p-[24px] bg-[#EAECF0] w-full h-auto mt-7 rounded-[10px]"
            ...
            >
              ...
              <div className="mt-5">
                <h1 className="text-[#101828] font-[700] text-[1.4vw]">
                  Ready to Move Apartments starting from AED 1.8m
                </h1>
                <ul className="grid grid-cols-2 mt-7 text-[1vw] text-[#101828] font-[600] gap-x-[100px] gap-y-[15px] list-disc pl-6">
                  <li>
                    <span className="font-[700]">Features:</span> Stylish, modern condo with open floor plan and upscale
                    amenities.
                  </li>
                  <li>
                    <span className="font-[700]">Financing:</span> Up to 80% financing available.
                  </li>
                  <li>
                    <span className="font-[700]">Convenience:</span> Easy commuting due to proximity to metro.
                  </li>
                  <li>
                    <span className="font-[700]">Proximity:</span> Close to vibrant city center, shopping, and
                    entertainment.
                  </li>
                </ul>
              </div>
