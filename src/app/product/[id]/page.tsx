        ...
        <div className="w-full mt-6 mb-32 md:max-w-full max-md:mb-10 flex">
            ...
            <div className="flex flex-col md:w-full">
              <div className="flex grow flex-col px-5 max-md:max-w-full max-md:mt-8">
                <div className="flex-col overflow-hidden self-stretch relative rounded-[12px] flex md:min-h-[757px] h-[300px] w-full pl-4 pr-20 py-4 items-start max-md:max-w-full max-md:pr-5">
                  <img
                    loading="lazy"
                    srcSet="https://images.pexels.com/photos/1335077/pexels-photo-1335077.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                ...
                <p className="text-gray-900 text-justify md:text-base text-[3.5vw] leading-7 tracking-normal self-stretch mt-6 max-md:max-w-full">
