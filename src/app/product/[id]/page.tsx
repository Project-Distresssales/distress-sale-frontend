      ...
      <>
        <div className="w-full h-auto p-10 mt-5">
          <div className="flex h-auto gap-16">
            <div className="">
              {isLoading ? (
                <Skeleton variant="rectangular" animation="wave" className="h-[400px] rounded-[12px] min-w-[450px]" />
              ) : (
                <div className="h-[400px] rounded-[12px] min-w-[450px]">
                  <img
                    src={selectedImage}
                ...
                {isLoading ? (
                  ...
                  <div className="flex gap-3 items-center">
                    ...
                    <div className="bg-[#F8C85E] py-[5px] px-[10px] rounded-[2px] flex justify-center items-center">
                      <p className="leading-none text-[#191C1F] text-[14px] font-[500]">
          ...
          {/* Tab */}
          <div className="text-[14px] mx-auto flex items-center justify-start gap-1 bg-[#FBFBFC] w-full rounded-[6px] mt-20">
            {tabs.map((tab, index) => (
