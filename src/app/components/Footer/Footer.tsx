    ...
    return (
        <footer className="w-full bg-[#ccd0db] p-4 sm:px-[80px] px-5 sm:py-20 py-10 items-center justify-between">
            <div className="mx-auto max-w-screen-xl space-y-8 px-4 pt-7 sm:px-6 lg:space-y-16 lg:px-8 mt-10">
                    ...
                    <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4">
                        <div>
                            ...
                            <ul className="mt-6 space-y-4 text-sm">
                                <li>
                                    <Link href="/privacy-policy" className="text-gray-700 transition hover:opacity-75">Terms of Use</Link>
                                </li>
                                ...
                                <li>
                                    <Link href="/benefits" className="text-gray-700 transition hover:opacity-75">Benefits</Link>
                                </li>

                                <li>
                                    <Link href="/faq" className="text-gray-700 transition hover:opacity-75">FAQ</Link>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="mt-6 space-y-4 text-sm">
                                <li>
                                    <Link href="/privacy-policy" className="text-gray-700 transition hover:opacity-75">Abu Dhabi</Link>
                                </li>

                                <li>
                                    <Link href="/privacy-policy" className="text-gray-700 transition hover:opacity-75">Dubai</Link>
                                </li>

                                <li>
                                    <Link href="/benefits" className="text-gray-700 transition hover:opacity-75">Sharjah</Link>
                                </li>

                                <li>
                                    <Link href="/faq" className="text-gray-700 transition hover:opacity-75">Ajman</Link>
                                </li>

                                <li>
                                    <Link href="/faq" className="text-gray-700 transition hover:opacity-75">UAQ</Link>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="mt-6 space-y-4 text-sm">
                                <li>
                                    <Link href="#" className="text-gray-700 transition hover:opacity-75">Help</Link>
                                </li>
                ...
                <p className="text-xs text-gray-500">&copy; 2024 DistressSale. All rights reserved.</p>
            </div>
        </footer>
    );
}