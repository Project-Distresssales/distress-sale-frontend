...
export default function ProductCard({ product }: any) {
    ...
    return (
        <div className='bg-white w-full h-auto p-5 rounded-[10px] cursor-pointer relative'
            ...
            <div className="px-[8px] py-[3px] rounded-[5px] flex justify-center items-center absolute right-[32px] bottom-[210px]"
