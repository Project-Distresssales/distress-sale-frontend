      ...
      <div className="flex flex-col gap-6">
        ...
        <div className=" grid grid-cols-2 gap-6  w-full ">
          <fieldset className="w-full flex items-center gap-6">
            <label className="font-medium whitespace-nowrap w-[169px] ">Title</label>
            <TextField label="Insert Title" />
          </fieldset>
          <fieldset className="w-full justify-end flex items-center gap-6">
            <label className="font-medium whitespace-nowrap w-[114px] text-right ">Kilometer</label>
            <TextField label="Insert kilometer" />
          </fieldset>
        </div>
         ...
         <div className=" grid grid-cols-2 gap-6  w-full ">
          <fieldset className="w-full flex items-center gap-6">
            <label className="font-medium whitespace-nowrap w-[169px]">Make & Model</label>
            <TextField label="Insert make & model" />
          </fieldset>
          <fieldset className="w-full justify-end flex items-center gap-6">
            <label className="font-medium whitespace-nowrap w-[114px] text-right ">Kilometer</label>
            <TextField label="Insert kilometer" />
        ...
        <div className=" grid grid-cols-2 gap-6  w-full">
          ...
          <fieldset className="w-full justify-end flex items-center gap-6">
            <label className="font-medium whitespace-nowrap w-[114px] text-right ">Closing Fee</label>
            <TextField label="What is the Closing Fee?" />
          </fieldset>
        </div>
      </div>
      {/* Upload Photos */}
