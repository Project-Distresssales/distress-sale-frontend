                ...
                <div className="container mx-auto">
                    <div className="flex items-center justify-between py-5">
                        ...
                        <div className="hidden sm:flex sm:items-center gap-7">
                            <Link href="#" className="text-gray-800 text-sm font-semibold">Home</Link>
                            <Link href="#" className="text-gray-800 text-sm font-semibold">About Us</Link>
                            <Link href="#" className="text-gray-800 text-sm font-semibold">FAQ's</Link>
                        </div>

                        <div className="hidden sm:flex sm:items-center gap-7">
                            <Link href="/" className="text-white text-sm outline-none focus:outline-0 font-semibold border px-4 py-2 rounded-md bg-secondary">Register</Link>
                            <Link href="/" className="text-secondary text-sm font-semibold">Login</Link>
                        </div>
