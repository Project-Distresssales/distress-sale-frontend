...
export default function CategoryCard({ product }: any) {
    return (
        <div className='bg-white w-full h-auto p-5 rounded-[10px] cursor-pointer product-container shadow-md'
        ...
        >
            ...
            <h1 className='text-[#101828] md:text-[1.2vw] text-[4.5vw] font-[700] leading-none mt-3'>{product.header}</h1>
        </div>
    )
}
