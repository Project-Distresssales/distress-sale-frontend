...
export default function VerifiedUserBadge() {
    ...
    return (
        <div className="w-full md:h-[120px] h-auto rounded-[10px] flex"
            ...
            <div className="w-full bg-[#E7EDFE] px-5 flex md:flex-row flex-col justify-between md:items-center items-start space-y-5 md:space-y-0 rounded-r-[10px] py-5">
                <div className='space-y-2'>
                    <p className="text-[#415EFF] md:text-[18px] font-[700] text-[3.5vw] font-[700]">Verified User</p>
                    <p className='text-[#6F85FF] md:text-[14px] font-[500] text-[2.8vw] font-[500] md:w-[500px] w-full'>You are now qualified for Ad Posting and This will also Increase your online presence and help you reach a wider audience.</p>
                </div>
                <div>
