...
const Step1: React.FC<Step1Props> = ({ handleClick, currentStep, steps }) => {
  return (
    <div className="flex flex-col w-full">
      {/* Select Package */}
      <div className="flex flex-col gap-16 justify-center items-center w-full mb-7">
      ...
      <div className="flex flex-col md:gap-16 gap-7 justify-center items-center w-full mt-20">
      ...
      {/* <div className="flex flex-col md:gap-16 gap-7 justify-center items-center w-full">
        ...
        {/* FAQ */}
      <div className="flex flex-col gap-16 justify-center items-center w-full mt-20">
